...
import { FRAME_BYTES_OPTIONS, SEND_PRESETS, TX_FPS_OPTIONS } from "../shared/send-settings.ts";
...
test("the sender exposes both canonical profiles", () => {
  assert.deepEqual(SEND_PRESETS.reliable, { txFps: 24, frameBytes: 1465 });
